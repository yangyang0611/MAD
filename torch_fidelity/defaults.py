DEFAULTS = {
    ...
    "input3_cache_name": None,
    "input3_model_z_type": "normal",
    "input3_model_z_size": None,
    "input3_model_num_classes": 0,
    "input3_model_num_samples": None,
    "input4_cache_name": None,
    "input4_model_z_type": "normal",
    "input4_model_z_size": None,
    "input4_model_num_classes": 0,
    "input4_model_num_samples": None,
    "rng_seed": 2020,
    "save_cpu_ram": False,
    "verbose": True,
}
