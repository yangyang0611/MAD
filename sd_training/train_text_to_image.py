"""Adapted from official diffusers example: https://github.com/huggingface/diffusers/tree/main/examples/text_to_image"""
...
from dataset.text_dataset import MTTextDataset
...
def parse_args():
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        help=("A json file containing the description text"),
    )
    parser.add_argument(
        "--image_column",
        type=str,
...
def main():
    ...
    train_dataset = MTTextDataset(
        args.train_data_dir, args.train_json_file, tokenizer, transforms=train_transforms
    )
